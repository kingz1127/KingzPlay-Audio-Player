...
//     getAlbumArt, getTrackColor, deleteTrack,
...
//           onPress={() => localFiltered.length > 0 && playTrack(localFiltered[0].id)}
//         >
...
//                     styles.thumbnail,
//                     {
//                       backgroundColor: getTrackColor(item.filename),
...
//                 styles.miniArt,
//                 {
//                   backgroundColor: getTrackColor(currentTrack.filename),
//                   justifyContent: "center", alignItems: "center",
//                 },
//               ]}
//             >
//               <Text style={{ color: "white", fontWeight: "bold" }}>
//                 {currentTrack.filename.charAt(0).toUpperCase()}
//               </Text>
//             </View>
//           )}
...
//                   <Image source={{ uri: selectedTrack.artwork }} style={styles.optionsArt} />
//                 ) : (
//                   <View
//                     style={[
//                       styles.optionsArt,
//                       {
//                         backgroundColor: getTrackColor(selectedTrack.filename),
//                         justifyContent: "center", alignItems: "center",
//                       },
//                     ]}
//                   >
//                     <Text style={{ color: "white", fontWeight: "bold", fontSize: 20 }}>
//                       {selectedTrack.filename.charAt(0).toUpperCase()}
//                     </Text>
//                   </View>
//                 )}
//                 <View style={{ flex: 1 }}>
...
//                 selectedTrack && playTrack(selectedTrack.id);
//               }}
//             >
...
//   thumbnailLetter: { color: "white", fontWeight: "bold", fontSize: 22 },
